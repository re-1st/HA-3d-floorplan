 ...
 * SPDX-License-Identifier: BSD-3-Clause
 */
var v;p.finalized=!0,p.elementProperties=new Map,p.elementStyles=[],p.shadowRootOptions={mode:"open"},null==d||d({ReactiveElement:p}),(null!==(l=c.reactiveElementVersions)&&void 0!==l?l:c.reactiveElementVersions=[]).push("1.5.0");const b=window,y=b.trustedTypes,_=y?y.createPolicy("lit-html",{createHTML:t=>t}):void 0,$=`lit$${(Math.random()+"").slice(9)}$`,w="?"+$,S=`<${w}>`,C=document,x=(t="")=>C.createComment(t),A=t=>null===t||"object"!=typeof t&&"function"!=typeof t,E=Array.isArray,M=/<(?:(!--|\/[^a-zA-Z])|(\/?[a-zA-Z][^>\s]*)|(\/?$))/g,k=/-->/g,D=/>/g,O=RegExp(">|[ \t\n\f\r](?:([^\\s\"'>=/]+)([ \t\n\f\r]*=[ \t\n\f\r]*(?:[^ \t\n\f\r\"'`<>=]|(\"|')|))|$)","g"),N=/'/g,H=/"/g,z=/^(?:script|style|textarea|title)$/i,R=(t=>(e,...r)=>({_$litType$:t,strings:e,values:r}))(1),T=Symbol.for("lit-noChange"),j=Symbol.for("lit-nothing"),P=new WeakMap,U=C.createTreeWalker(C,129,null,!1);class I{constructor({strings:t,_$litType$:e},r){let i;this.parts=[];let n=0,s=0;const a=t.length-1,o=this.parts,[l,c]=((t,e)=>{const r=t.length-1,i=[];let n,s=2===e?"<svg>":"",a=M;for(let e=0;e<r;e++){const r=t[e];let o,l,c=-1,u=0;for(;u<r.length&&(a.lastIndex=u,l=a.exec(r),null!==l);)u=a.lastIndex,a===M?"!--"===l[1]?a=k:void 0!==l[1]?a=D:void 0!==l[2]?(z.test(l[2])&&(n=RegExp("</"+l[2],"g")),a=O):void 0!==l[3]&&(a=O):a===O?">"===l[0]?(a=null!=n?n:M,c=-1):void 0===l[1]?c=-2:(c=a.lastIndex-l[2].length,o=l[1],a=void 0===l[3]?O:'"'===l[3]?H:N):a===H||a===N?a=O:a===k||a===D?a=M:(a=O,n=void 0);const h=a===O&&t[e+1].startsWith("/>")?" ":"";s+=a===M?r+S:c>=0?(i.push(o),r.slice(0,c)+"$lit$"+r.slice(c)+$+h):r+$+(-2===c?(i.push(void 0),e):h)}const o=s+(t[r]||"<?>")+(2===e?"</svg>":"");if(!Array.isArray(t)||!t.hasOwnProperty("raw"))throw Error("invalid template strings array");return[void 0!==_?_.createHTML(o):o,i]})(t,e);if(this.el=I.createElement(l,r),U.currentNode=this.el.content,2===e){const t=this.el.content,e=t.firstChild;e.remove(),t.append(...e.childNodes)}for(;null!==(i=U.nextNode())&&o.length<a;){if(1===i.nodeType){if(i.hasAttributes()){const t=[];for(const e of i.getAttributeNames())if(e.endsWith("$lit$")||e.startsWith($)){const r=c[s++];if(t.push(e),void 0!==r){const t=i.getAttribute(r.toLowerCase()+"$lit$").split($),e=/([.?@])?(.*)/.exec(r);o.push({type:1,index:n,name:e[2],strings:t,ctor:"."===e[1]?B:"?"===e[1]?Z:"@"===e[1]?J:q})}else o.push({type:6,index:n})}for(const e of t)i.removeAttribute(e)}if(z.test(i.tagName)){const t=i.textContent.split($),e=t.length-1;if(e>0){i.textContent=y?y.emptyScript:"";for(let r=0;r<e;r++)i.append(t[r],x()),U.nextNode(),o.push({type:2,index:++n});i.append(t[e],x())}}}else if(8===i.nodeType)if(i.data===w)o.push({type:2,index:n});else{let t=-1;for(;-1!==(t=i.data.indexOf($,t+1));)o.push({type:7,index:n}),t+=$.length-1}n++}}static createElement(t,e){const r=C.createElement("template");return r.innerHTML=t,r}}function Y(t,e,r=t,i){var n,s,a,o;if(e===T)return e;let l=void 0!==i?null===(n=r._$Co)||void 0===n?void 0:n[i]:r._$Cl;const c=A(e)?void 0:e._$litDirective$;return(null==l?void 0:l.constructor)!==c&&(null===(s=null==l?void 0:l._$AO)||void 0===s||s.call(l,!1),void 0===c?l=void 0:(l=new c(t),l._$AT(t,r,i)),void 0!==i?(null!==(a=(o=r)._$Co)&&void 0!==a?a:o._$Co=[])[i]=l:r._$Cl=l),void 0!==l&&(e=Y(t,l._$AS(t,e.values),l,i)),e}class L{constructor(t,e){this.u=[],this._$AN=void 0,this._$AD=t,this._$AM=e}get parentNode(){return this._$AM.parentNode}get _$AU(){return this._$AM._$AU}v(t){var e;const{el:{content:r},parts:i}=this._$AD,n=(null!==(e=null==t?void 0:t.creationScope)&&void 0!==e?e:C).importNode(r,!0);U.currentNode=n;let s=U.nextNode(),a=0,o=0,l=i[0];for(;void 0!==l;){if(a===l.index){let e;2===l.type?e=new W(s,s.nextSibling,this,t):1===l.type?e=new l.ctor(s,l.name,l.strings,this,t):6===l.type&&(e=new V(s,this,t)),this.u.push(e),l=i[++o]}a!==(null==l?void 0:l.index)&&(s=U.nextNode(),a++)}return n}p(t){let e=0;for(const r of this.u)void 0!==r&&(void 0!==r.strings?(r._$AI(t,r,e),e+=r.strings.length-2):r._$AI(t[e])),e++}}class W{constructor(t,e,r,i){var n;this.type=2,this._$AH=j,this._$AN=void 0,this._$AA=t,this._$AB=e,this._$AM=r,this.options=i,this._$Cm=null===(n=null==i?void 0:i.isConnected)||void 0===n||n}get _$AU(){var t,e;return null!==(e=null===(t=this._$AM)||void 0===t?void 0:t._$AU)&&void 0!==e?e:this._$Cm}get parentNode(){let t=this._$AA.parentNode;const e=this._$AM;return void 0!==e&&11===t.nodeType&&(t=e.parentNode),t}get startNode(){return this._$AA}get endNode(){return this._$AB}_$AI(t,e=this){t=Y(this,t,e),A(t)?t===j||null==t||""===t?(this._$AH!==j&&this._$AR(),this._$AH=j):t!==this._$AH&&t!==T&&this.g(t):void 0!==t._$litType$?this.$(t):void 0!==t.nodeType?this.T(t):(t=>E(t)||"function"==typeof(null==t?void 0:t[Symbol.iterator]))(t)?this.k(t):this.g(t)}O(t,e=this._$AB){return this._$AA.parentNode.insertBefore(t,e)}T(t){this._$AH!==t&&(this._$AR(),this._$AH=this.O(t))}g(t){this._$AH!==j&&A(this._$AH)?this._$AA.nextSibling.data=t:this.T(C.createTextNode(t)),this._$AH=t}$(t){var e;const{values:r,_$litType$:i}=t,n="number"==typeof i?this._$AC(t):(void 0===i.el&&(i.el=I.createElement(i.h,this.options)),i);if((null===(e=this._$AH)||void 0===e?void 0:e._$AD)===n)this._$AH.p(r);else{const t=new L(n,this),e=t.v(this.options);t.p(r),this.T(e),this._$AH=t}}_$AC(t){let e=P.get(t.strings);return void 0===e&&P.set(t.strings,e=new I(t)),e}k(t){E(this._$AH)||(this._$AH=[],this._$AR());const e=this._$AH;let r,i=0;for(const n of t)i===e.length?e.push(r=new W(this.O(x()),this.O(x()),this,this.options)):r=e[i],r._$AI(n),i++;i<e.length&&(this._$AR(r&&r._$AB.nextSibling,i),e.length=i)}_$AR(t=this._$AA.nextSibling,e){var r;for(null===(r=this._$AP)||void 0===r||r.call(this,!1,!0,e);t&&t!==this._$AB;){const e=t.nextSibling;t.remove(),t=e}}setConnected(t){var e;void 0===this._$AM&&(this._$Cm=t,null===(e=this._$AP)||void 0===e||e.call(this,t))}}class q{constructor(t,e,r,i,n){this.type=1,this._$AH=j,this._$AN=void 0,this.element=t,this.name=e,this._$AM=i,this.options=n,r.length>2||""!==r[0]||""!==r[1]?(this._$AH=Array(r.length-1).fill(new String),this.strings=r):this._$AH=j}get tagName(){return this.element.tagName}get _$AU(){return this._$AM._$AU}_$AI(t,e=this,r,i){const n=this.strings;let s=!1;if(void 0===n)t=Y(this,t,e,0),s=!A(t)||t!==this._$AH&&t!==T,s&&(this._$AH=t);else{const i=t;let a,o;for(t=n[0],a=0;a<n.length-1;a++)o=Y(this,i[r+a],e,a),o===T&&(o=this._$AH[a]),s||(s=!A(o)||o!==this._$AH[a]),o===j?t=j:t!==j&&(t+=(null!=o?o:"")+n[a+1]),this._$AH[a]=o}s&&!i&&this.j(t)}j(t){t===j?this.element.removeAttribute(this.name):this.element.setAttribute(this.name,null!=t?t:"")}}class B extends q{constructor(){super(...arguments),this.type=3}j(t){this.element[this.name]=t===j?void 0:t}}const F=y?y.emptyScript:"";class Z extends q{constructor(){super(...arguments),this.type=4}j(t){t&&t!==j?this.element.setAttribute(this.name,F):this.element.removeAttribute(this.name)}}class J extends q{constructor(t,e,r,i,n){super(t,e,r,i,n),this.type=5}_$AI(t,e=this){var r;if((t=null!==(r=Y(this,t,e,0))&&void 0!==r?r:j)===T)return;const i=this._$AH,n=t===j&&i!==j||t.capture!==i.capture||t.once!==i.once||t.passive!==i.passive,s=t!==j&&(i===j||n);n&&this.element.removeEventListener(this.name,this,i),s&&this.element.addEventListener(this.name,this,t),this._$AH=t}handleEvent(t){var e,r;"function"==typeof this._$AH?this._$AH.call(null!==(r=null===(e=this.options)||void 0===e?void 0:e.host)&&void 0!==r?r:this.element,t):this._$AH.handleEvent(t)}}class V{constructor(t,e,r){this.element=t,this.type=6,this._$AN=void 0,this._$AM=e,this.options=r}get _$AU(){return this._$AM._$AU}_$AI(t){Y(this,t)}}const K=b.litHtmlPolyfillSupport;null==K||K(I,W),(null!==(v=b.litHtmlVersions)&&void 0!==v?v:b.litHtmlVersions=[]).push("2.5.0");
/**
 * @license
 * Copyright 2017 Google LLC
 * SPDX-License-Identifier: BSD-3-Clause
 */
var G,X;class Q extends p{constructor(){super(...arguments),this.renderOptions={host:this},this._$Dt=void 0}createRenderRoot(){var t,e;const r=super.createRenderRoot();return null!==(t=(e=this.renderOptions).renderBefore)&&void 0!==t||(e.renderBefore=r.firstChild),r}update(t){const e=this.render();this.hasUpdated||(this.renderOptions.isConnected=this.isConnected),super.update(t),this._$Dt=((t,e,r)=>{var i,n;const s=null!==(i=null==r?void 0:r.renderBefore)&&void 0!==i?i:e;let a=s._$litPart$;if(void 0===a){const t=null!==(n=null==r?void 0:r.renderBefore)&&void 0!==n?n:null;s._$litPart$=a=new W(e.insertBefore(x(),t),t,void 0,null!=r?r:{})}return a._$AI(t),a})(e,this.renderRoot,this.renderOptions)}connectedCallback(){var t;super.connectedCallback(),null===(t=this._$Dt)||void 0===t||t.setConnected(!0)}disconnectedCallback(){var t;super.disconnectedCallback(),null===(t=this._$Dt)||void 0===t||t.setConnected(!1)}render(){return T}}Q.finalized=!0,Q._$litElement$=!0,null===(G=globalThis.litElementHydrateSupport)||void 0===G||G.call(globalThis,{LitElement:Q});const tt=globalThis.litElementPolyfillSupport;null==tt||tt({LitElement:Q}),(null!==(X=globalThis.litElementVersions)&&void 0!==X?X:globalThis.litElementVersions=[]).push("3.2.0");
/**
 * @license
 * Copyright 2017 Google LLC
 * SPDX-License-Identifier: BSD-3-Clause
...
`,ge=t=>t<10?`0${t}`:t;function me(t,e,r){return t>0?`${t}:${ge(e)}:${ge(r)}`:e>0?`${e}:${ge(r)}`:""+r}const fe=t=>me(Math.floor(t/3600),Math.floor(t%3600/60),Math.floor(t%3600%60)),pe=t=>me(0,Math.floor(t/3600),Math.ceil(t%3600/60));function ve(t){return Object.assign(Object.assign({active_state:["active","on","manual","program","once_program"],pause_state:"paused",waiting_state:"waiting",guess_mode:!1,end_time:{attribute:"end_time"},start_time:{attribute:"start_time"},duration:{attribute:"duration"},remain_time:{attribute:"remain_time"},sync_issues:"show",bar_width:"calc(70% - 7em)",bar_height:"8px",text_width:"3.5em",bar_background:"#eee",bar_foreground:"var(--mdc-theme-primary, #6200ee);",bar_radius:"0",layout:"normal",resolution:"seconds"},t),{translations:Object.assign({scheduled_for:"Scheduled for",once_program:"Once Program",program:"Program",manual:"Manual",waiting:"Waiting"},t.translations)})}function be(t,e,r,i,n=!0){if(!e)return"";if(i&&i[e])return i[e];if(r){const i=function(t,e,r,i){var n=void 0!==i?i:e.state;if("unknown"===n||"unavailable"===n)return t("state.default."+n);if(e.attributes.unit_of_measurement)return Tt(n,r)+" "+e.attributes.unit_of_measurement;var s=function(t){return function(t){return t.substr(0,t.indexOf("."))}(t.entity_id)}(e);if("input_datetime"===s){var a;if(!e.attributes.has_time)return a=new Date(e.attributes.year,e.attributes.month-1,e.attributes.day),Ht(a,r);if(!e.attributes.has_date){var o=new Date;return a=new Date(o.getFullYear(),o.getMonth(),o.getDay(),e.attributes.hour,e.attributes.minute),Rt(a,r)}return a=new Date(e.attributes.year,e.attributes.month-1,e.attributes.day,e.attributes.hour,e.attributes.minute),zt(a,r)}return"humidifier"===s&&"on"===n&&e.attributes.humidity?e.attributes.humidity+" %":"counter"===s||"number"===s?Tt(n,r):e.attributes.device_class&&t("component."+s+".state."+e.attributes.device_class+"."+e.state)||t("component."+s+".state._."+e.state)||e.state}(t.localize,r,t.locale,e);if(i!==e)return n?i:i.toLowerCase()}const s=function(t,e){return"idle"===e?t.localize("component.timer.state._.idle"):"paused"===e?t.localize("component.timer.state._.paused"):"active"===e?t.localize("component.timer.state._.active"):"on"===e?t.localize("component.switch.state._.on"):void 0}(t,e);return s?n?s:s.toLowerCase():n?e[0].toUpperCase()+e.substring(1):e}class ye extends Q{constructor(){super(...arguments),this._previousClockCorrection=0,this._browserClockCorrection=0}disconnectedCallback(){super.disconnectedCallback(),this._clearInterval()}connectedCallback(){var t;if(super.connectedCallback(),this.config&&this.config.entity){const e=null===(t=this.hass)||void 0===t?void 0:t.states[this.config.entity];e&&this._startInterval(e)}}_mode(){return Kt(this.hass,this.config,this._browserClockCorrection)}render(){var t,e,r;const i=this.hass.states[this.config.entity];if(this._error)return R`<hui-warning>${this._error.message}</hui-warning>`;let n,s=0;try{i&&(s=null!==(t=Wt(this.hass,this.config,i,this._browserClockCorrection))&&void 0!==t?t:0)}catch(t){return R`<hui-warning>${t}</hui-warning>`}s>100&&(s=100);try{n=Object.assign(Object.assign({},this.modConfig),{icon:null!==(e=this.modConfig.active_icon)&&void 0!==e?e:this.modConfig.icon})}catch(t){return R`<div>${t}</div>`}const a="none"!==(null===(r=n.tap_action)||void 0===r?void 0:r.action)?"pointer":"";switch(this._mode()){case"active":return this._renderRow(n,R`
        ${this._renderBar(s)}
        ${this._renderTime(a)}
      `);case"pause":return this._renderRow(n,R`
        ${this._renderStatus(a,"")}
        ${this._renderTime(a)}
      `);case"waiting":return this._renderRow(this.modConfig,R`
        ${this._renderStatus(a,(t=>{const e=new Date(t.attributes.start_time),r=JSON.parse(localStorage.getItem("selectedLanguage")||'"en"')||"en";return Rt(e,r)})(i))}
      `);default:const t=this.modConfig.text_width&&0===parseInt(this.modConfig.text_width)?"visibility: hidden":"";return this._renderRow(this.modConfig,R`
        <div class="text-content value ${a}" style=${t}
        @action=${ue(this.hass,this.config)}
       .actionHandler=${ce(this.config)}
        >${this._renderState(i)}</div>
      `)}}_renderState(t){return R`${this.localize(t)}`}localize(t,e=!0){return be(this.hass,null==t?void 0:t.state,t,this.config.translations,e)}_renderRow(t,e){const r=this._warning?R`<hui-warning>${this._warning}</hui-warning>`:"";return this.modConfig.full_row||"full_row"===this.modConfig.layout?R`${r}<div class="flex" @action=${ue(this.hass,t)} .actionHandler=${ce(t)}> ${e}</div>${this._renderDebug()}`:("hide_name"===this.modConfig.layout&&(t=Object.assign(Object.assign({},t),{name:""})),R`
      ${r}
      ${function(t,e,r){var i,n;if(!e||!r)return R``;const s=r.entity?e.states[r.entity]:void 0;if(!s)return R`<hui-warning>Entity ${r.entity} not found</hui-warning>`;const a=null!==(i=r.name)&&void 0!==i?i:(t=>{return void 0===t.attributes.friendly_name?(e=t.entity_id,e.substring(e.indexOf(".")+1)).replace(/_/g," "):t.attributes.friendly_name||"";var e})(s),o="none"!==(null===(n=r.tap_action)||void 0===n?void 0:n.action)?"pointer":"";return R`<div class="generic-entity-row">
    <state-badge
      class="${o}"
      .hass=${e}
      .stateObj=${s}
    ...
    ${he(r.extend_paper_buttons_row,"right")}
      ...
      ${this._renderDebug()}
    `)}_renderTime(t){const e=this.modConfig.format?this.modConfig.format:function(t,e){switch("automatic"===e?function(t){return t>=3600?"minutes":"seconds"}(t):e){case"seconds":return"hms";case"minutes":return"hm"}}(this._timeRemaining||0,this.modConfig.resolution);return R`<div class="text-content value ${t}" style=${this._textStyle()}
      @action=${ue(this.hass,this.config)}
      .actionHandler=${ce(this.config)}>
...
`,xe=["primary","accent","red","pink","purple","deep-purple","indigo","blue","light-blue","cyan","teal","green","light-green","lime","yellow","amber","orange","deep-orange","brown","grey","blue-grey","black","white","disabled"];function Ae(t){if("primary"===t||"accent"===t)return`var(--rgb-${t}-color)`;if(xe.includes(t))return`var(--rgb-${t})`;if(t.startsWith("#")){const e=parseInt(t.substring(1),16);return isNaN(e)?"":[e>>16&255,e>>8&255,255&e].join(", ")}return t}const Ee=["button","input_button","scene"];function Me(t,e,r,i,n){switch(t){case"name":return e;case"state":const t=i.entity_id.split(".")[0];return"timestamp"!==i.attributes.device_class&&!Ee.includes(t)||!function(t){return"unavailable"!==t.state}(i)||function(t){return"unknown"===t.state}(i)?r:R`
                    <ha-relative-time
                        .hass=${n}
                        .datetime=${i.state}
                        capitalize
                    ></ha-relative-time>
                `;case"last-changed":return R`
                <ha-relative-time
                    .hass=${n}
                    .datetime=${i.last_changed}
                    capitalize
                ></ha-relative-time>
            `;case"last-updated":return R`
                <ha-relative-time
                    .hass=${n}
                    .datetime=${i.last_updated}
                    capitalize
                ></ha-relative-time>
            `;case"none":return}}const ke=t=>{return void 0===t.attributes.friendly_name?(e=t.entity_id,e.substring(e.indexOf(".")+1)).replace(/_/g," "):t.attributes.friendly_name||"";var e},De=t=>t&&!!t.themes.darkMode;class Oe extends ye{constructor(){super(...arguments),this.mushroom={}}updated(t){if(super.updated(t),t.has("hass")&&this.hass){const e=De(t.get("hass")),r=De(this.hass);e!==r&&this.toggleAttribute("dark-mode",r)}}_renderRow(t,e){var r;if(!this.hass)return R``;const i=this._warning?R`<hui-warning>${this._warning}</hui-warning>`:"",n=function(t){var e=t.locale.language||"en";return t.translationMetadata.translations[e]&&t.translationMetadata.translations[e].isRTL||!1}(this.hass),s=this.hass.states[this.config.entity],a=null!==(r=t.name)&&void 0!==r?r:ke(s);"hide_name"===this.modConfig.layout&&(t=Object.assign(Object.assign({},t),{name:""}));const o=this.appearance(),l=Me(o.primary_info,a,this.localize(s,!1),s,this.hass);return R`
      <ha-card class=${o.fill_container?"fill-container":""}>
        ...
        ${this._renderDebug()}
      </ha-card>`}_renderState(t){var e;const r=null!==(e=this.config.name)&&void 0!==e?e:ke(t),i=this.appearance(),n=this.localize(t,!1);return Me(i.secondary_info,r,n,t,this.hass)}_renderIcon(t){const e=this.config.icon,r="active"==this._mode();let i="";if(this.mushroom.icon_color||this.mushroom.color){const t=Ae(this.mushroom.color||this.mushroom.icon_color);i+=`--icon-color:rgb(${t});`,i+=`--shape-color:rgba(${t}, 0.2);`}return R`<mushroom-shape-icon slot="icon" .disabled=${!r} style=${i}>
      <ha-state-icon .hass=${this.hass} .stateObj=${t} .state=${t} .icon=${e}></ha-state-icon>
    </mushroom-shape-icon>`}_renderBadge(t){return"unavailable"===t.state?R`<mushroom-badge-icon class="unavailable" slot="badge" icon="mdi:help"></mushroom-badge-icon>`:j}appearance(){var t,e,r,i,n;return{layout:null!==(t=this.mushroom.layout)&&void 0!==t?t:"default",fill_container:null!==(e=this.mushroom.fill_container)&&void 0!==e&&e,primary_info:null!==(r=this.mushroom.primary_info)&&void 0!==r?r:"name",secondary_info:null!==(i=this.mushroom.secondary_info)&&void 0!==i?i:"state",icon_type:null!==(n=this.mushroom.icon_type)&&void 0!==n?n:"icon"}}localize(t,e){return super.localize(t,!1)}static get styles(){return[super.styles,a`
            :host {
                ${_e}
            }
            :host([dark-mode]) {
